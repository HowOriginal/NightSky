...
public class EditStory extends Activity implements OnClickListener {
	...
	// when button is clicked, call edit class
	public void onClick(View v) {
		new JsonReadTask2().execute();
	}

	@Override
	// when this class is created set up the window environment
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.edit_screen);
		Button mSubmit = (Button) findViewById(R.id.save_story);
	...
	// this task connects the story first and gets the story
	class JsonReadTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				para.add(new BasicNameValuePair("id", uclass.storyid));
	...
	// 2nd async task to submit (submit the edited version)
