...
public class SkyView extends Activity  implements SensorEventListener{
	...
	class MyRenderer implements GLSurfaceView.Renderer {
		...
		public void onSurfaceChanged(GL10 gl, int w, int h) {
			...
			if (master == null) {
				...
				Texture texture = new Texture(BitmapHelper.rescale(BitmapHelper.convert(getResources().getDrawable(R.drawable.sky)), 64, 64));
