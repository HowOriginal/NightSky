...
public class SecondActivity extends Activity {
	...
	private String jsonResult;
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
	  ...
	  final Button viewinsky = (Button) findViewById(R.id.button1);
	     viewinsky.setOnClickListener(new View.OnClickListener() {
		 ...
		 final Button readstory = (Button) findViewById(R.id.button2);
	     readstory.setOnClickListener(new View.OnClickListener() {
	         public void onClick(View v) {
	             // Perform action on click   

	             Intent activityChangeIntent = new Intent(SecondActivity.this, ReadStory.class);
